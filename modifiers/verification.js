    ...
    client.on("guildMemberAdd", async member => {
        ...
        try {
            ...
            if (err.name === "Cannot send messages to this user") {
                ...
                return notificationChannel.send(`:x: ${member}, This server has a verification system, we wanted to send you a DM/PM with a captcha but we cant :tired_face:! Leave the server and open your DM's/PM's And try again! https://gyazo.com/ba952e813b92bb62422e3ac05160a7ff`);
            }
        }
